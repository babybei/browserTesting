(function(global) {
	...
	var RECORDED_AUDIO_TYPE_MP3 = "audio/mp3";
	...
	Recorder = {
		...
		onConvert2MP3 : function(name){
			Recorder.recorder.onConvert2MP3(name);
		},
		...
		getMp3Blob : function(base64Data){
//			var data = 'data:' + RECORDED_AUDIO_TYPE_MP3 + ';base64,' + base64Data;
			return base64toBlob(base64Data, RECORDED_AUDIO_TYPE_MP3);
		},
		...
		byteToString : function(name) {
			return Recorder.recorder.byteToString(name);
		},
				...
				if (options && options.permanent) {
					try {
						...
						if(attempt < 20) {
						    ...
						    console.log('permissionCommand attempt:' + attempt);
						}
						return;
					}
				} else {
